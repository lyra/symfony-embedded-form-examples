...
class ShippingDetails
{
     ...
     * Set the fields to send to the payment api to create payment.
     *
     * @param  string  $deliveryCompanyName  The fields to send to the payment api to create payment.
     *
     * @return  self
     */ 
    public function setDeliveryCompanyName(string $deliveryCompanyName)
    {
     ...
     * Set the fields to send to the payment api to create payment.
     *
     * @param  string  $legalName  The fields to send to the payment api to create payment.
     *
     * @return  self
     */ 
     ...
     * Set the fields to send to the payment api to create payment.
     *
     * @param  string  $shippingMethod  The fields to send to the payment api to create payment.
     *
     * @return  self
     */ 
     ...
     * Set the fields to send to the payment api to create payment.
     *
     * @param  string  $shippingSpeed  The fields to send to the payment api to create payment.
     *
     * @return  self
     */ 
    public function setShippingSpeed(string $shippingSpeed)
    {
